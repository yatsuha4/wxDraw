...
{
  appendMember("Size.Alignment", size_.alignment);
  appendMember("Size.Offset", size_.offset);
  appendMember("Pos.Alignment", pos_.alignment);
  appendMember("Pos.Offset", pos_.offset);
